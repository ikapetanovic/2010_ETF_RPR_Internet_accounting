...
public:
	KorisnikOsoba (String ^username, String ^naziv_paketa, String ^adresa, String ^password, String ^telefon, bool modem, String ^ime, String ^prezime, String ^broj_licne_karte) 
