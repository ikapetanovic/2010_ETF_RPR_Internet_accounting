...
public:
	KorisnikOsoba (String ^username, String ^naziv_paketa, String ^adresa, String ^password, String ^telefon, String ^ime, String ^prezime, String ^broj_licne_karte) 
		: Korisnik (username, naziv_paketa, adresa, password, telefon), _ime (ime), _prezime (prezime), _broj_licne_karte (broj_licne_karte) {}
